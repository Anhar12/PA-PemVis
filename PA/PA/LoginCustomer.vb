...
Public Class LoginCustomer
    ...
    Private Sub LoginCustomer_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
    ...
    Private Sub LoginCustomer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        If cek() = True Then
            CMD = New MySqlCommand("Select * from akun where username = '" & txtUsername.Text & "' and password = '" & txtPassword.Text & "' and level = 'customer'", CONN)
            RD = CMD.ExecuteReader()
            RD.Read()
            If RD.HasRows Then
                If txtUsername.Text = RD("username") And txtPassword.Text = RD("password") Then
                    USERNAME_CUSTOMER = RD("username")
                    RD.Close()
                    Customerpage.Show()
                    Me.Close()
                Else
